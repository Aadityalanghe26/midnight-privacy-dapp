...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.incrementWitness) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named incrementWitness');
    }
  ...
  _incrementWitness_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.incrementWitness(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('incrementWitness',
                                 'return value',
  ...
  _increment_0(context, partialProofData) {
    const w_0 = this._incrementWitness_0(context, partialProofData);
    __compactRuntime.assert(w_0 > 0n, 'Witness must be a positive integer');
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
...
const _dummyContract = new Contract({
  incrementWitness: (...args) => undefined
});
